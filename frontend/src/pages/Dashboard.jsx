...
const TotalIncomeIcon = ({ size = 24, style }) => (
  <svg width={size} height={size} viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg" style={style}>
...
const DealValueOvertimeIcon = ({ size = 24, style }) => (
  <svg width={size} height={size} viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg" style={style}>
...
const RevenueGeneratedIcon = ({ size = 24, style }) => (
  <svg width={size} height={size} viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg" style={style}>
...
function Dashboard() {
  ...
  if (activeDashboardTab === "CRM") {
    ...
    const crmKpis = [
      ...
      { icon: Video, label: "Meetings Today", value: meetingsTodayCount, trend: `${meetingsTrend.pct}% this month`, trendUp: meetingsTrend.up },
