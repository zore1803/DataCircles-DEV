        ...
        <div className="flex-1 min-w-[120px]">
          <div className="flex items-baseline justify-between gap-2">
            <span className="text-xs font-semibold text-blue-700">
              {label}
              {isAtLimit && (
                <span className="text-red-600 ml-1">· at limit</span>
              )}
            </span>
    ...
    return (
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
        <div className="flex items-center gap-2 mb-2.5">
          ...
          <p className="text-xs font-bold text-blue-900">Seat Usage</p>
        </div>
    ...
    <div className="space-y-6 -mt-10 lg:-mt-12">
      ...
      <div className="min-h-0 flex-1 flex flex-col">
        {loading ? (
          ...
          <div className="flex-1 min-h-0 overflow-auto border-y border-gray-200">
                    ...
                    <tr key={u._id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 bg-pink-200 rounded-full flex items-center justify-center text-gray-800 text-xs font-bold shrink-0">
                            {u.name
                              .split(" ")
                              .map((p) => p.charAt(0))
                              .join("")
                        ...
                        {u.role === "admin" ? (
                          ...
                          <div className="flex items-center justify-end gap-2">
                            <button
                              ...
                              className="inline-flex items-center gap-1 px-3 py-1.5 text-blue-600 rounded-lg hover:bg-blue-50 text-sm font-semibold transition-colors"
                            >
                              <Shield className="w-4 h-4" />
                              Permissions
                            </button>
                            <button
                              className="inline-flex items-center gap-1 px-3 py-1.5 text-red-600 rounded-lg hover:bg-red-50 text-sm font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                              disabled={isSelf}
        ...
        <aside className="w-full lg:w-80 space-y-4 mt-1.5 lg:mt-0 lg:fixed lg:top-[150px] lg:right-6 lg:bottom-6 lg:overflow-y-auto lg:pr-1">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5 text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <p className="text-xs font-bold text-gray-900">Organization Code</p>
            </div>
            {orgCode ? (
              <span className="block font-mono text-xl font-bold text-gray-900 break-all">
                {orgCode}
              </span>
            ) : orgCodeError ? (
              <span className="flex items-center justify-center gap-2 text-xs font-medium text-red-600">
                {orgCodeError}
                <button
              ...
              <span className="block font-mono text-xl font-bold text-gray-400">
                Loading...
              </span>
            )}
            ...
            <div className="flex gap-2 mt-3">
              <button
                ...
                disabled={!orgCode}
                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 text-xs font-semibold disabled:opacity-50 transition-colors"
              >
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 bg-gray-900 text-white rounded-lg hover:bg-gray-800 text-xs font-semibold transition-colors"
              >
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5">
            ...
            {loading ? (
              ...
              <p className="text-xs text-gray-400 py-2">No pending invites.</p>
            ) : (
                ...
                {invites.map((invite) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="shrink-0 text-red-600 hover:bg-red-50 rounded p-1 transition-colors"
                      title="Revoke"
                    >
                      <X className="w-4 h-4" />
                    </button>
      ...
      {formVisible && (
        <div
          className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center z-[100009] p-4"
          onClick={() => !paymentProcessing && setFormVisible(false)}
        >
          <div
            className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl border-2 border-gray-200 max-h-[90vh] overflow-y-auto"
