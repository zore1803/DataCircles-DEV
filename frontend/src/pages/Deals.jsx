    ...
    <div className="bg-white min-h-screen font-sans">
      ...
      >
        ...
        <div className="flex flex-row items-center self-stretch" style={{ gap: "24px", height: "72px" }}>
          {[
            { label: "Open Deals", value: dealStatistics.openCount, icon: OpenDealsIcon },
            { label: "Pipeline Value", value: `₹${formatNumberToIndian(dealStatistics.totalPipeline)}`, icon: PipelineValueIcon },
            { label: "Won Deals", value: dealStatistics.wonCount, icon: WonDealsIcon },
