            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-600 ml-8 mt-1">
                  Includes auto-fetch functionality
                </p>
              </div>
              <span className="text-xs text-gray-500 bg-gray-200 px-3 py-1 rounded-full font-medium whitespace-nowrap mt-2 sm:mt-0">
                System Field
          ...
          <div className="border-2 border-gray-200 rounded-xl p-4 sm:p-5 bg-gray-50">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-600 ml-8 mt-1">
                  Includes Line 1, Line 2, City, State, Pincode, Country
                </p>
              </div>
              <span className="text-xs text-gray-500 bg-gray-200 px-3 py-1 rounded-full font-medium whitespace-nowrap mt-2 sm:mt-0">
                System Field
        ...
        <div className="mt-4 bg-blue-50 border-2 border-blue-200 rounded-xl p-4">
          <div className="flex flex-col sm:flex-row items-start gap-3">
            ...
            <p className="text-sm text-blue-700">
              These are built-in system fields that appear by default in every vendor form. You cannot edit or remove these fields, but you can add custom fields below.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="text"
                placeholder="e.g., Vendor Code, Payment Terms, Credit Limit"
                value={newField.name}
                onChange={(e) =>
