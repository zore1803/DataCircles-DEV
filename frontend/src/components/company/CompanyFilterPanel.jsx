...
export default function CompanyFilterPanel({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-[26px] w-[min(90vw,560px)] min-w-[420px] max-w-[560px] max-h-[90vh] overflow-hidden shadow-2xl border border-gray-100 flex flex-col animate-in slide-in-from-right duration-300"
