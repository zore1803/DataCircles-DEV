          ...
          >
            {options.map((option) => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-1.5 text-[13px] transition-colors hover:bg-gray-50 ${value === option ? "bg-blue-50/50 text-blue-600" : "text-gray-600"}`}
              >
