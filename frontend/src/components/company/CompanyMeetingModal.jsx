...
const CompanyMeetingModal = ({
  ...
  // For create mode: Assigned To, defaults for other fields
  const initialState = {
    title: "",
    time: "09:00",
    duration: 60,
    ...
    meetingData
      ? {
          ...
          time: meetingData.scheduledAt
            ...
            : "09:00",
          assignedTo: meetingData.assignedTo?._id || meetingData.assignedTo || ""
        }
      : initialState
  );
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl mx-4">
        <div className="flex items-center justify-between px-8 py-6 border-b">
          <h2 className="text-2xl font-bold text-gray-900">
            {mode === "create" ? "Schedule Company Meeting" : "Meeting Details"}
          </h2>
          <button
            type="button"
            onClick={onClose}
          ...
          {mode === "create" ? (
            ...
            <div className="grid grid-cols-2 gap-8">
              ...
              <div className="space-y-5 pr-4 border-r border-gray-200">
                ...
                <div>
                  <span className="block font-semibold text-gray-700 mb-2">Assigned To</span>
                  <span className="text-gray-900"><span className="bg-gray-200 rounded px-2 py-1">{meetingData.assignedTo?.name || meetingData.assignedTo || "—"}</span></span>
                </div>
                <div>
...
export default CompanyMeetingModal;
