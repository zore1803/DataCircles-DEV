...
const PerformaInvoiceStylePreview = ({ style: initialStyle, isOpen, onClose }) => {
  if (!isOpen) return null;

  const [selectedStyle, setSelectedStyle] = useState(initialStyle || 'Classic');
  const styleImages = {
    Classic: 'https://getswipe.azureedge.net/getswipe/images/templates/temp-1.webp',
    Modern: 'https://getswipe.azureedge.net/getswipe/images/templates/temp-2.webp',
    Elegant: 'https://getswipe.azureedge.net/getswipe/images/templates/temp-3.webp',
    Minimal: 'https://getswipe.azureedge.net/getswipe/images/templates/temp-4.webp',
  };
      ...
      <div className="bg-white rounded-xl p-6 w-full max-w-5xl shadow-2xl max-h-[85vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold text-slate-900 flex items-center gap-2">
            ...
            {selectedStyle} Pro Forma Invoice Preview
          </h3>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="space-y-4">
          ...
          <div className="border border-slate-200 rounded-lg p-4 bg-slate-50">
            <img
              ...
              alt={`${selectedStyle} Pro Forma Invoice Preview`}
...
export default PerformaInvoiceStylePreview;