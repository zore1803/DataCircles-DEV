/*
 * The product's notification bell glyph, from the design system.
 *
 * Replaces lucide's Bell icon. Its natural viewBox is a 16x20 column (taller
 * than wide), so sizing it with the usual `w-4 h-4` centres it inside a
 * square icon slot without stretching; the path is filled with
 * `currentColor`, so colour comes from a `text-*` class exactly like the
