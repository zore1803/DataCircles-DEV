/*
 * The product's download glyph, from the design system.
 *
 * Replaces lucide's <Download /> everywhere so every download button/link
 ...
 */
const DownloadIcon = ({ className = "w-4 h-4", size, style, ...props }) => (
  <svg
    viewBox="0 0 16 16"
    fill="none"
