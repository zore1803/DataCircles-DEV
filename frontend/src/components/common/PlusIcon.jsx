/*
 * The product's plus/add glyph, from the design system.
 *
 * Replaces lucide's Plus icon everywhere so every "Add" button/menu item
 * shows the same mark. It's a square 14x14 viewBox, so sizing it with the
 ...
 */
const PlusIcon = ({ className = "w-4 h-4", size, style, ...props }) => (
  <svg
    viewBox="0 0 14 14"
    fill="none"
